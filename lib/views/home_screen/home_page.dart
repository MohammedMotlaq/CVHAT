...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer3<ReviewsProvider, ProfileProvider, AuthProvider>(builder:
        (context, reviewsProvider, profileProvider, authProvider, child) {
      return Scaffold(
                              ...
                              Stack(
                                children: [
                                  ReviewCard(
                                      ...
                                      value: reviewsProvider
                                          .recruiterReviewsCount),
                                  const ComingSoon(
                                      height: 139,
                                      width: 165,
                                      showAnimation: false)
